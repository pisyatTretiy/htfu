...
/**
 * Крючок с поплавком. Над водой — баллистика; под водой сопротивление гасит
 * снос вбок, а вертикаль задаётся профилем погружения. Физдвижок не нужен:
 * контактов между телами нет.
 */
export class Hook3D {
