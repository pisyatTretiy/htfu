...
export type CatchShape =
  | 'fish'
  | 'eel'
  /** Высокое тело блюдцем: карась, губан. */
  | 'round'
  /** Пластина, сплющенная с боков: палтус, топорик. */
  | 'flat'
  /** Игла с длинным носом: сарган, рыба-гадюка. */
  | 'needle'
  /** Шар в иглах: рыба-ёж. */
  | 'puffer'
  /** Тело в длинных лучах: крылатка, скорпена. */
  | 'spiny'
  /** Голова с фонарём на стебле: удильщик. */
  | 'lure'
  /** Пасть больше самой рыбы: бочкоглот. */
  | 'jaws'
  /** Стоит на трёх лучах: треногая рыба. */
  | 'stilts'
  | 'crab'
  | 'jelly'
  | 'squid'
